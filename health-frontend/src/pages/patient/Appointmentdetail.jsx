        ...
        >
            ...
            >
                ...
                <div
                    ...
                    {[1, 2, 3, 4, 5].map(n => (
                        <button
                            key={n} onClick={() => onRatingChange(n)}
                            style={{
                                background: "none",
                                border: "none",
                                cursor: "pointer",
            ...
            <div style={{
                ...
                <div style={{ background: T.green, paddingBottom: 56 }}>
                    ...
                    <div className="w-full px-6 lg:px-16 xl:px-24 2xl:px-32"
                        ...
                        <button onClick={() => navigate("/patient/appointments")}
                            ...
                            onMouseLeave=
                            {e => e.currentTarget.style.color = "rgba(255,255,255,.8)"}
                        >
                            <ArrowLeft size={16} /> Back to Appointments
                        </button>
                ...
                <div className="w-full px-6 lg:px-16 xl:px-24 2xl:px-32"
                    ...
                    <div style={{
                        ...
                        padding: 28,
                        boxShadow: "0 12px 32px rgba(22,51,43,.08)"
                    }}>
                        ...
                        <div style={{
                            ...
                            <InfoItem
                                icon={<Calendar size={17} color={T.green} />}
                                label="Date"
                                value={fmtDate(appt.appointmentDate)}
                            />

                            <InfoItem
                                icon={<Clock size={17} color={T.green} />}
                                label="Time"
                                value={fmtTime(appt.appointmentTime)}
                            />

                            <InfoItem
                                icon={<MapPin size={17} color={T.green} />}
                                label="Place to visit"
                                value={appt.placeToVisit}
                            />
                        ...
                        {hasAnyAction ? (
                            <div style={{
                                ...
                                {appt.status === "Completed" && !appt.isReviewed && (
                                    <ActionButton icon={<Star size={15} />}
                                        label="Rate Doctor"
                                ...
                                {appt.status === "Confirmed" && (
                                    <ActionButton
                                        ...
                                        onClick={() => setCancelOpen(true)} bg="#FEE2E2" fg="#DC2626"
                                    />
                                )}
