...
function LoadingSkeleton() {
    return (
        <div style={{ minHeight: "100vh", background: T.cream, padding: "36px 20px" }}>
            <style>{`@keyframes pulse{0%,100%{opacity:1}50%{opacity:.5}}`}</style>
            <div style={{ maxWidth: 560, margin: "0 auto" }}>
                <div style={{ height: 18, width: 80, background: T.creamDark, borderRadius: 8, marginBottom: 24, animation: "pulse 1.5s infinite" }} />
                <div style={{ background: T.white, borderRadius: 24, border: `1px solid ${T.border}`, overflow: "hidden" }}>
                    <div style={{ height: 180, background: T.creamDark, animation: "pulse 1.5s infinite" }} />
                    <div style={{ padding: 28 }}>
                        {[...Array(4)].map((_, i) => (
                            <div key={i} style={{ height: 14, background: T.creamDark, borderRadius: 6, marginBottom: 16, width: `${70 - i * 8}%`, animation: "pulse 1.5s infinite" }} />
                        ))}
                    </div>
                </div>
            </div>
...
function PaymentModal({ open, amount, onClose, onSuccess }) {
    ...
    return (
        <div style={{
            ...
            <div style={{
                background: T.white, borderRadius: 24, width: "100%", maxWidth: 420,
                ...
                {stage === "form" && (
                    <>
                        <div style={{
                            background: T.greenDeep, padding: "24px 28px", display: "flex",
                            alignItems: "center", justifyContent: "space-between",
                        }}>
                            <div>
                                <p style={{ color: "#BFD3C6", fontSize: 12, fontWeight: 600, margin: 0, letterSpacing: .4 }}>
                                    CareConnect Secure Pay
                                </p>
                                <h2 style={{ color: T.white, fontFamily: "Fraunces, Georgia, serif", fontWeight: 700, fontSize: 24, margin: "4px 0 0" }}>
                                    ₹{amount}
                                </h2>
                            </div>
                            <button onClick={onClose} style={{
                                border: "none", background: "rgba(255,255,255,.15)", width: 32, height: 32,
                        ...
                        <form onSubmit={handlePay} style={{ padding: "24px 28px" }}>
                            ...
                            <div style={{ position: "relative", marginBottom: 14 }}>
                                <CreditCard size={16} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: T.muted }} />
                                <input
                                    value={card.number}
                            ...
                            <button type="submit" style={{
                                ...
                                border: "none", background: T.terra, color: T.white, fontWeight: 700,
                            ...
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginTop: 14 }}>
                                ...
                                <span style={{ fontSize: 11, color: T.muted }}>Secured, encrypted test transaction</span>
                            </div>
                        </form>
                    </>
                )}
                ...
                {stage === "processing" && (
                    <div style={{ padding: "60px 28px", textAlign: "center" }}>
                        <Loader2 size={44} color={T.green} style={{ animation: "spin 1s linear infinite" }} />
                        <h3 style={{ fontFamily: "Fraunces, Georgia, serif", fontWeight: 700, fontSize: 18, color: T.ink, margin: "20px 0 6px" }}>
                            Processing Payment
                        </h3>
                        <p style={{ fontSize: 13, color: T.muted, margin: 0 }}>Please don't close this window…</p>
                    </div>
                )}
                ...
                {stage === "success" && (
                    <div style={{ padding: "50px 28px", textAlign: "center" }}>
                        <div style={{
                            width: 72, height: 72, borderRadius: "50%", background: T.greenLight,
                            display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto",
                        }}>
                            <CheckCircle2 size={38} color={T.green} />
                        </div>
                        <h3 style={{ fontFamily: "Fraunces, Georgia, serif", fontWeight: 700, fontSize: 20, color: T.ink, margin: "20px 0 6px" }}>
                            Payment Successful
                        </h3>
                        <p style={{ fontSize: 13, color: T.muted, margin: 0 }}>₹{amount} paid for your ambulance ride</p>
                    </div>
                )}
            </div>
