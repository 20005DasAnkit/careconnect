            ...
            <div className="min-h-screen bg-[#FAF8F3] text-[#16332B] font-[Georgia,serif]">
                ...
                <header className="sticky top-0 z-50 bg-[#FAF8F3]/95 backdrop-blur-sm border-b border-[#E4DFD3]">
                    <div className="max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
                        ...
                        <nav className="hidden lg:flex items-center gap-9 font-[system-ui,sans-serif] text-[15px] text-[#16332B]/80">
                            ...
                            <a href="/patient/Locations" className="hover:text-[#16332B] transition">
                                Locations
                            </a>
                            ...
                            >
                                ...
                                {aboutOpen && (
                                    <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-[#E4DFD3] overflow-hidden z-50">
                                        <a href="/patient/AboutUs" className="block px-5 py-3 hover:bg-[#F5F5F0]">
                                            About Us
                                        </a>
                                        <a href="/patient/blog" className="block px-5 py-3 hover:bg-[#F5F5F0]">
                                            Blogs
                                        </a>
                                        <a href="/patient/Contacts" className="block px-5 py-3 hover:bg-[#F5F5F0]">
                                            Contact Us
                                        </a>
                                    </div>
                                )}
                ...
                <section className="max-w-7xl mx-auto px-6 lg:px-10 mt-24">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
                        {[
                            { title: "Cardiology", Icon: HeartPulse, color: "text-red-500" },
                            { title: "Neurology", Icon: Brain, color: "text-pink-500" },
                            { title: "Orthopedic", Icon: Bone, color: "text-amber-500" },
                            { title: "Ophthalmology", Icon: Eye, color: "text-blue-500" },
                            { title: "General Medicine", Icon: Stethoscope, color: "text-green-600" },
                            { title: "Pediatrics", Icon: Baby, color: "text-yellow-500" },
                        ].map((item) => (
                            <button
                                key={item.title}
